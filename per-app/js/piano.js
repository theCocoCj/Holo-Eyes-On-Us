...
function cambioBase() {
    ...
    if(base !== undefined)
        base.pause();
    base = new Audio('img/' + BTN.innerHTML + '.mp3');    // Create a new Audio object with the file path specified by the button's innerHTML, (equals to the name of th song)
